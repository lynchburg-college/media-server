...
*/
 ...
 $ACCESS_PWD='carnegie1501'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"lcmedia",#required
 'pwd'=>"carnegie1501", #required
 'db'=>"lcmedia",  #optional, default DB
 'host'=>"",#optional
 'port'=>"",#optional
